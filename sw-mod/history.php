  ...
  echo'<!-- App Capsule -->
    ...
    <div class="card-body">
        ...
        <div class="col-sm-4 col-md-4 justify-content-between">
           <button type="button" class="btn btn-danger mt-1 mr-1 btn-sortir"><ion-icon name="checkmark-outline"></ion-icon>Tampilkan</button>
           <button type="button" class="btn btn-warning mt-1 mr-1" data-toggle="modal" data-target="#modal-print"><ion-icon name="print-outline"></ion-icon> Cetak</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="action-sheet-content">
                            ...
                            <div class="form-group basic">
                                <button type="button" class="btn btn-danger btn-block  mt-2 btn-print"><ion-icon name="print-outline"></ion-icon> Cetak</button>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="input-wrapper">
                                        ...
                                        <select class="form-control custom-select" name="present_id" id="status" required>';
                                            $query="SELECT * from present_status order by present_name ASC";
                                              ...
                                              echo'<option value="'.$row['present_name'].'">'.$row['present_name'].'</option>';
                                              }echo'
                                        </select>
                                    </div>
                                </div>
