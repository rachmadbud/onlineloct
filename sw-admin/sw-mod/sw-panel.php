...
echo'<aside class="main-sidebar">
    ...
    if($level_user =='1'){
      ...
      if($mod =='laporan-absensi-waktu'){echo'<li class="active">'; }else{echo'<li>';}
      echo'<a href="./laporan-absensi-waktu"><i class="fa fa-list-alt" aria-hidden="true"></i> <span>Laporan Absensi/Jam</span></a></li>';
